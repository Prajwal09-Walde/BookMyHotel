        ...
        { type !== "list" && 
          <>
           ...
           <div className="HeaderSearchItem">
             ...
             >
               {`${options.adult} adult . ${options.children} children . ${options.room} room/s . ${options.bed} bed`}
             </span>
             {openOptions && (
              <div className="options">
                ...
                <div className="OptionsItem">
                  <span className="OptionsText">Bed</span>
                  <div className="OptionCounter">
                    <button 
                     className="OptionCounterButton"
                     disabled={options.bed <= 1}
                     onClick={() => handleOption("bed", "d")}
                    >
                      -
                    </button>
                    <span className="OptionCounterNumber">
                    ...
                    <button
                     className="OptionCounterButton"
                     disabled={options.bed >= 2}
                     onClick={() => handleOption("bed", "i")}
                    >
                     +
                    </button>
                  </div>
